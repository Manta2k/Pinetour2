...
export const GetInTouch = () => {
  const [textToCopy, setTextToCopy] = useState("reachsagarshah@gmail.com");
  ...
  return (
    <div className="flex justify-center w-full bg-slate-50  dark:bg-slate-900">
      <div
        id="contact"
        className="flex flex-col items-center container mb-[200px] dark:bg-slate-900 max-md:mb-[50px]"
      >
        <div className="mt-[100px]">
          <Minititle />
        </div>
        <h1 className="flex flex-wrap w-[50%] text-center text-gray-600 text-[25px] mt-[50px] max-md:w-full">
          What’s next? Feel free to reach out to me if you're looking for a
          developer, have a query, or simply want to connect.
        </h1>
        <div className="flex justify-center items-center gap-x-[40px] font-semibold mt-[50px]">
          <div>
            <svg
          ...
          <div
            ...
            className="hover:bg-slate-300 hover:rounded-lg cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
        ...
        <div className="flex justify-center items-center gap-x-[40px] font-semibold">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
          ...
          <div className="text-[35px]">+91 8980500565</div>
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
        ...
        <h1 className="text-[20px] text-slate-700 mt-[60px]">
