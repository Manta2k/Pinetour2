...
export const GetInTouch = () => {
  return (
    <div
      id="contact"
      className="flex flex-col items-center container mb-[200px]"
    >
      <div className="mt-[100px]">
        <Minititle />
      </div>
      <h1 className="flex flex-wrap w-[50%] text-center text-gray-600 text-[25px] mt-[50px]">
      ...
      <div className="flex justify-center items-center gap-x-[40px] font-semibold mt-[50px]">
        ...
        <div className="text-[35px]">reachsagarshah@gmail.com</div>
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
